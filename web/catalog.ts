...
export const historicalFeatures = { ...v2.features, ...v3.features, ...v4.features, ...v5.features };
...
export const configurationKind = (key: string): string => historicalFeatures[key as keyof typeof historicalFeatures].configuration;
