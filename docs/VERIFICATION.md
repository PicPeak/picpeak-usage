...
| Full public/aggregate visibility, no bucket suppression | Latest per-installation projections without lookup IDs/keys, complete NDJSON export, adoption/version/layout/history views. Single-installation aggregate/export tests. |
